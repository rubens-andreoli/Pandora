...
public class Speaker {
    ...
    public BufferedImage drawImage(float volume){
	...
	if(timer>0){
	    ...
	    if(volume >= 0.3) g.drawArc(-20, -9, 40, 40, -15, 30);
	    if(volume >= 0.6) g.drawArc(-15, -9, 40, 40, -25, 50);
	    if(volume >= 0.8) g.drawArc(-10, -9, 40, 40, -35, 70);
	}
